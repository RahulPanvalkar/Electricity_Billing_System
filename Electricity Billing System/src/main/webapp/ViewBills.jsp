...
<body>
	...
	<div class="container">
		...
		<div class="search-box">
			<input type="text" id="searchText" placeholder="Search by BillNum / MeterNum" style="width:250px" oninput="searchData(1, 2, 'billTable')"/>
		</div>
				...
				<c:choose>
					<c:when test="${count < 5}">
						<tr>
							...
							<td><a href="#" onclick="removeBill('${bill.billNum}')">Remove</a></td>
						</tr>
	...
	function removeBill(billNo){
		...
		let confirmValue =  confirm("Are you sure ? All the details of billNo : "+billNo+" will be permanantly deleted");
		console.log("confirmValue : "+confirmValue);
		if(confirmValue){
			callServlet("billNo", billNo);
		}
	}
